...
class PatientReportAdapter @Inject constructor() :
    RecyclerView.Adapter<PatientReportAdapter.ViewHolder>() {
    private lateinit var context: Context

    inner class ViewHolder(private val binding: ItemPatientReportBinding) :
    ...
    class ImageZoomDialog : DialogFragment() {
        ...
        override fun onCreateView(
            ...
            val adapter: ImageZoomAdapter = PatientReportAdapter().ImageZoomAdapter(context!!)
...
//                            imgDisplay.setImageDrawable(resource)
    ...
    ): PatientReportAdapter.ViewHolder {
