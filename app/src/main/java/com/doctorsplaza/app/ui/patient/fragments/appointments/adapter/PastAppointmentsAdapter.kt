...
class PastAppointmentsAdapter @Inject constructor(): RecyclerView.Adapter<PastAppointmentsAdapter.ViewHolder>() {
   ...
   private val diffUtil = object :DiffUtil.ItemCallback<AppointmentData>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PastAppointmentsAdapter.ViewHolder {
