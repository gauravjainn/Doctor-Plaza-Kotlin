package com.doctorsplaza.app.utils.slidingrootnav;
...
import com.doctorsplaza.app.utils.slidingrootnav.slideUtil.ActionBarToggleAdapter;
import com.doctorsplaza.app.utils.slidingrootnav.slideUtil.DrawerListenerAdapter;
import com.doctorsplaza.app.utils.slidingrootnav.slideUtil.HiddenMenuClickConsumer;
import com.doctorsplaza.app.utils.slidingrootnav.transform.CompositeTransformation;
import com.doctorsplaza.app.utils.slidingrootnav.transform.ElevationTransformation;
import com.doctorsplaza.app.utils.slidingrootnav.transform.RootTransformation;
import com.doctorsplaza.app.utils.slidingrootnav.transform.ScaleTransformation;
import com.doctorsplaza.app.utils.slidingrootnav.transform.YTranslationTransformation;
...
public class SlidingRootNavBuilder {
    ...
    private ViewGroup getContentView() {
        ...
        if (contentView.getChildCount() != 1) {
            throw new IllegalStateException("Bad content view");
        }
        return contentView;
    }
    ...
    private View getMenuViewFor(SlidingRootNavLayout parent) {
        if (menuView == null) {
            if (menuLayoutRes == 0) {
                throw new IllegalStateException("Illegal exception: No view ");
            }
