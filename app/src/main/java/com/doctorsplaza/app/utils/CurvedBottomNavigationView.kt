...
import np.com.susanthapa.curved_bottom_navigation.toPx
...
class CurvedBottomNavigationView @JvmOverloads constructor(
    ...
    private var navElevation = 6.toPx(context).toFloat()
        set(value) {
            field = value
    ...
    var fabBackgroundColor = Color.RED
        set(value) {
            field = value
    ...
    var navBackgroundColor = Color.BLACK
        set(value) {
            field = value
    ...
    private var cbnMenuItems: Array<CbnMenuItems> = arrayOf()
    ...
    private var menuItemClickListener: ((CbnMenuItems, Int) -> Unit)? = null
    ...
    fun setMenuItems(cbnMenuItems: Array<CbnMenuItems>, activeIndex: Int = 0) {
    ...
    fun getMenuItems(): Array<CbnMenuItems> {
        return cbnMenuItems
    }

    // set the click listener for menu items
    private fun setOnMenuItemClickListener(menuItemClickListener: (CbnMenuItems, Int) -> Unit) {
    ...
    private fun navigateToDestination(navController: NavController, itemCbn: CbnMenuItems) {
